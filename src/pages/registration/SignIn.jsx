...
function SignIn() {
  return (
    <>
      <div
        className="lg:h-[44.5em] md:[44em] h-[34em]"
        style={{
          background:
      ...
      >
        <div className="main flex justify-center items-center h-screen ">
          <div className="sub_main bg-black bg-opacity-75 p-20">
            ...
            <div className="mb-1">
              <button className="bg-[#e50815] w-full px-3 py-3 rounded-md text-white outline-none ">
                Sign In
              </button>
            </div>
            <div className=" mb-10">
            ...
            <div className=" mb-5">
              ...
              <Link to={"/"}>
                <span className=" font-light hover:underline text-white mx-1">
                 Sign up now.
                </span>
              </Link>
            </div>
